...
const ReadingData = {
    ...
    _phonicsData: {
        ...
        nonsense: [
            ...
            // V44: Expanded nonsense words for anti-memorization variety
            // FastBridge research recommends 200+ rotating pool; bumps total well past 100.
            { word: 'lig', rhymesWith: 'pig', wrongs: ['lag', 'log', 'lug'] },
            { word: 'mab', rhymesWith: 'cab', wrongs: ['meb', 'mib', 'mob'] },
            { word: 'rop', rhymesWith: 'hop', wrongs: ['rap', 'rip', 'rup'] },
            { word: 'tem', rhymesWith: 'hem', wrongs: ['tam', 'tim', 'tom'] },
            { word: 'vop', rhymesWith: 'top', wrongs: ['vap', 'vip', 'vup'] },
            { word: 'sup', rhymesWith: 'cup', wrongs: ['sap', 'sip', 'sop'] },
            { word: 'naf', rhymesWith: 'staff', wrongs: ['nif', 'nof', 'nuf'] },
            { word: 'bep', rhymesWith: 'step', wrongs: ['bap', 'bip', 'bop'] },
            { word: 'dop', rhymesWith: 'pop', wrongs: ['dap', 'dip', 'dup'] },
            { word: 'fim', rhymesWith: 'him', wrongs: ['fam', 'fom', 'fum'] },
            { word: 'gad', rhymesWith: 'sad', wrongs: ['gid', 'god', 'gud'] },
            { word: 'hib', rhymesWith: 'bib', wrongs: ['hab', 'hob', 'hub'] },
            { word: 'jed', rhymesWith: 'bed', wrongs: ['jad', 'jid', 'jud'] },
            { word: 'kob', rhymesWith: 'job', wrongs: ['kab', 'kib', 'kub'] },
            { word: 'lup', rhymesWith: 'pup', wrongs: ['lap', 'lip', 'lop'] },
            { word: 'med', rhymesWith: 'red', wrongs: ['mad', 'mid', 'mud'] },
            { word: 'nug', rhymesWith: 'bug', wrongs: ['nag', 'nig', 'nog'] },
            { word: 'pim', rhymesWith: 'rim', wrongs: ['pam', 'pom', 'pum'] },
            { word: 'rop', rhymesWith: 'mop', wrongs: ['rap', 'rep', 'rip'] },
            { word: 'sav', rhymesWith: 'have', wrongs: ['siv', 'suv', 'sev'] },
            { word: 'tig', rhymesWith: 'pig', wrongs: ['tag', 'tog', 'tug'] },
            { word: 'wob', rhymesWith: 'job', wrongs: ['wab', 'wib', 'wub'] },
            { word: 'yat', rhymesWith: 'cat', wrongs: ['yit', 'yot', 'yut'] },
            { word: 'zep', rhymesWith: 'step', wrongs: ['zap', 'zip', 'zop'] },
            { word: 'bot', rhymesWith: 'pot', wrongs: ['bat', 'bit', 'but'] },
            { word: 'dak', rhymesWith: 'sack', wrongs: ['dik', 'dok', 'duk'] },
            { word: 'feg', rhymesWith: 'beg', wrongs: ['fag', 'fig', 'fog'] },
            { word: 'gop', rhymesWith: 'cop', wrongs: ['gap', 'gip', 'gup'] },
            { word: 'lat', rhymesWith: 'bat', wrongs: ['lit', 'lot', 'lut'] },
            { word: 'nim', rhymesWith: 'him', wrongs: ['nam', 'nom', 'num'] },
            { word: 'pog', rhymesWith: 'log', wrongs: ['pag', 'pig', 'pug'] },
            { word: 'reb', rhymesWith: 'web', wrongs: ['rab', 'rib', 'rub'] },
            { word: 'sut', rhymesWith: 'but', wrongs: ['sat', 'sit', 'sot'] },
            { word: 'tev', rhymesWith: 'rev', wrongs: ['tav', 'tiv', 'tuv'] },
            { word: 'wid', rhymesWith: 'kid', wrongs: ['wad', 'wod', 'wud'] },
            // V45: Expanded to 200 entries per FastBridge anti-memorization spec (200+ rotating pool)
            { word: 'baf', rhymesWith: 'staff', wrongs: ['bef', 'bif', 'bof'] },
            { word: 'bek', rhymesWith: 'peck', wrongs: ['bak', 'bik', 'bok'] },
            { word: 'bem', rhymesWith: 'stem', wrongs: ['bam', 'bim', 'bom'] },
            { word: 'bif', rhymesWith: 'riff', wrongs: ['baf', 'bof', 'buf'] },
            { word: 'bik', rhymesWith: 'pick', wrongs: ['bak', 'bok', 'buk'] },
            { word: 'bil', rhymesWith: 'fill', wrongs: ['bal', 'bel', 'bul'] },
            { word: 'bip', rhymesWith: 'tip', wrongs: ['bap', 'bop', 'bup'] },
            { word: 'bup', rhymesWith: 'cup', wrongs: ['bap', 'bep', 'bip'] },
            { word: 'daf', rhymesWith: 'staff', wrongs: ['def', 'dif', 'dof'] },
            { word: 'dag', rhymesWith: 'flag', wrongs: ['dig', 'dog', 'dug'] },
            { word: 'dap', rhymesWith: 'tap', wrongs: ['dep', 'dip', 'dop'] },
            { word: 'deb', rhymesWith: 'web', wrongs: ['dab', 'dib', 'dob'] },
            { word: 'def', rhymesWith: 'chef', wrongs: ['daf', 'dif', 'dof'] },
            { word: 'deg', rhymesWith: 'beg', wrongs: ['dag', 'dig', 'dog'] },
            { word: 'dek', rhymesWith: 'peck', wrongs: ['dak', 'dik', 'dok'] },
            { word: 'dem', rhymesWith: 'stem', wrongs: ['dam', 'dim', 'dom'] },
            { word: 'dep', rhymesWith: 'pep', wrongs: ['dap', 'dip', 'dop'] },
            { word: 'det', rhymesWith: 'pet', wrongs: ['dat', 'dit', 'dut'] },
            { word: 'faf', rhymesWith: 'staff', wrongs: ['fef', 'fif', 'fof'] },
            { word: 'fef', rhymesWith: 'chef', wrongs: ['faf', 'fif', 'fof'] },
            { word: 'fek', rhymesWith: 'peck', wrongs: ['fak', 'fik', 'fok'] },
            { word: 'fel', rhymesWith: 'fell', wrongs: ['fal', 'fil', 'ful'] },
            { word: 'fep', rhymesWith: 'pep', wrongs: ['fap', 'fip', 'fop'] },
            { word: 'fet', rhymesWith: 'pet', wrongs: ['fat', 'fit', 'fut'] },
            { word: 'fif', rhymesWith: 'riff', wrongs: ['faf', 'fof', 'fuf'] },
            { word: 'fil', rhymesWith: 'fill', wrongs: ['fal', 'fel', 'ful'] },
            { word: 'gaf', rhymesWith: 'staff', wrongs: ['gef', 'gif', 'gof'] },
            { word: 'geb', rhymesWith: 'web', wrongs: ['gab', 'gib', 'gob'] },
            { word: 'ged', rhymesWith: 'bed', wrongs: ['gad', 'gid', 'gud'] },
            { word: 'gef', rhymesWith: 'chef', wrongs: ['gaf', 'gif', 'gof'] },
            { word: 'gek', rhymesWith: 'peck', wrongs: ['gak', 'gik', 'gok'] },
            { word: 'gep', rhymesWith: 'pep', wrongs: ['gap', 'gip', 'gup'] },
            { word: 'haf', rhymesWith: 'staff', wrongs: ['hef', 'hif', 'hof'] },
            { word: 'hek', rhymesWith: 'peck', wrongs: ['hak', 'hik', 'hok'] },
            { word: 'het', rhymesWith: 'pet', wrongs: ['hat', 'hit', 'hut'] },
            { word: 'hif', rhymesWith: 'riff', wrongs: ['haf', 'hef', 'hof'] },
            { word: 'hil', rhymesWith: 'fill', wrongs: ['hal', 'hel', 'hul'] },
            { word: 'jal', rhymesWith: 'pal', wrongs: ['jel', 'jil', 'jol'] },
            { word: 'jek', rhymesWith: 'peck', wrongs: ['jak', 'jik', 'jok'] },
            { word: 'jel', rhymesWith: 'bell', wrongs: ['jal', 'jil', 'jul'] },
            { word: 'jem', rhymesWith: 'stem', wrongs: ['jam', 'jim', 'jom'] },
            { word: 'jif', rhymesWith: 'riff', wrongs: ['jaf', 'jef', 'jof'] },
            { word: 'jik', rhymesWith: 'pick', wrongs: ['jak', 'jek', 'jok'] },
            { word: 'jil', rhymesWith: 'fill', wrongs: ['jal', 'jel', 'jul'] },
            { word: 'kel', rhymesWith: 'bell', wrongs: ['kal', 'kil', 'kol'] },
            { word: 'kem', rhymesWith: 'stem', wrongs: ['kam', 'kim', 'kom'] },
            { word: 'kib', rhymesWith: 'rib', wrongs: ['kab', 'kob', 'kub'] },
            { word: 'kif', rhymesWith: 'riff', wrongs: ['kaf', 'kef', 'kof'] },
            { word: 'kol', rhymesWith: 'doll', wrongs: ['kal', 'kel', 'kul'] },
            { word: 'lef', rhymesWith: 'chef', wrongs: ['laf', 'lif', 'lof'] },
            { word: 'lek', rhymesWith: 'peck', wrongs: ['lak', 'lik', 'lok'] },
            { word: 'lem', rhymesWith: 'stem', wrongs: ['lam', 'lim', 'lom'] },
            { word: 'lep', rhymesWith: 'pep', wrongs: ['lap', 'lip', 'lop'] },
            { word: 'lif', rhymesWith: 'riff', wrongs: ['laf', 'lef', 'lof'] },
            { word: 'lom', rhymesWith: 'prom', wrongs: ['lam', 'lim', 'lum'] },
            { word: 'lut', rhymesWith: 'strut', wrongs: ['lat', 'let', 'lit'] },
            { word: 'maf', rhymesWith: 'staff', wrongs: ['mef', 'mif', 'mof'] },
            { word: 'mek', rhymesWith: 'peck', wrongs: ['mak', 'mik', 'mok'] },
            { word: 'mep', rhymesWith: 'pep', wrongs: ['map', 'mip', 'mop'] },
            { word: 'mig', rhymesWith: 'pig', wrongs: ['mag', 'mog', 'mug'] },
            { word: 'muf', rhymesWith: 'muff', wrongs: ['maf', 'mef', 'mof'] },
            { word: 'nek', rhymesWith: 'peck', wrongs: ['nak', 'nik', 'nok'] },
            { word: 'nel', rhymesWith: 'bell', wrongs: ['nal', 'nil', 'nul'] },
            { word: 'nep', rhymesWith: 'pep', wrongs: ['nap', 'nip', 'nop'] },
            { word: 'nof', rhymesWith: 'off', wrongs: ['naf', 'nef', 'nuf'] },
            { word: 'paf', rhymesWith: 'staff', wrongs: ['pef', 'pif', 'pof'] },
            { word: 'peb', rhymesWith: 'web', wrongs: ['pab', 'pib', 'pob'] },
            { word: 'ped', rhymesWith: 'bed', wrongs: ['pad', 'pid', 'pud'] },
            { word: 'pel', rhymesWith: 'bell', wrongs: ['pal', 'pil', 'pul'] },
            { word: 'pif', rhymesWith: 'riff', wrongs: ['paf', 'pef', 'pof'] },
            { word: 'pil', rhymesWith: 'fill', wrongs: ['pal', 'pel', 'pul'] },
            { word: 'pob', rhymesWith: 'rob', wrongs: ['pab', 'pib', 'pub'] },
            { word: 'pof', rhymesWith: 'off', wrongs: ['paf', 'pef', 'puf'] },
            { word: 'rek', rhymesWith: 'peck', wrongs: ['rak', 'rik', 'rok'] },
            { word: 'rel', rhymesWith: 'bell', wrongs: ['ral', 'ril', 'rul'] },
            { word: 'rif', rhymesWith: 'riff', wrongs: ['raf', 'ref', 'rof'] },
            { word: 'saf', rhymesWith: 'staff', wrongs: ['sef', 'sif', 'sof'] },
            { word: 'sed', rhymesWith: 'bed', wrongs: ['sad', 'sid', 'sud'] },
            { word: 'sek', rhymesWith: 'peck', wrongs: ['sak', 'sik', 'sok'] },
            { word: 'sel', rhymesWith: 'bell', wrongs: ['sal', 'sil', 'sul'] },
            { word: 'sem', rhymesWith: 'stem', wrongs: ['sam', 'sim', 'som'] },
            { word: 'sif', rhymesWith: 'riff', wrongs: ['saf', 'sef', 'sof'] },
            { word: 'sil', rhymesWith: 'fill', wrongs: ['sal', 'sel', 'sul'] },
            { word: 'taf', rhymesWith: 'staff', wrongs: ['tef', 'tif', 'tof'] },
            { word: 'teb', rhymesWith: 'web', wrongs: ['tab', 'tib', 'tob'] },
            { word: 'tek', rhymesWith: 'peck', wrongs: ['tak', 'tik', 'tok'] },
            { word: 'tel', rhymesWith: 'bell', wrongs: ['tal', 'til', 'tul'] },
            { word: 'tep', rhymesWith: 'pep', wrongs: ['tap', 'tip', 'top'] },
            { word: 'tif', rhymesWith: 'riff', wrongs: ['taf', 'tef', 'tof'] },
            { word: 'vab', rhymesWith: 'cab', wrongs: ['veb', 'vib', 'vob'] },
            { word: 'vek', rhymesWith: 'peck', wrongs: ['vak', 'vik', 'vok'] },
            { word: 'vel', rhymesWith: 'bell', wrongs: ['val', 'vil', 'vul'] },
            { word: 'vep', rhymesWith: 'pep', wrongs: ['vap', 'vip', 'vop'] },
            { word: 'vif', rhymesWith: 'riff', wrongs: ['vaf', 'vef', 'vof'] },
            { word: 'vil', rhymesWith: 'fill', wrongs: ['val', 'vel', 'vul'] },
            { word: 'waf', rhymesWith: 'staff', wrongs: ['wef', 'wif', 'wof'] },
            { word: 'wek', rhymesWith: 'peck', wrongs: ['wak', 'wik', 'wok'] },
            { word: 'wep', rhymesWith: 'pep', wrongs: ['wap', 'wip', 'wop'] },
            { word: 'wif', rhymesWith: 'riff', wrongs: ['waf', 'wef', 'wof'] },
            { word: 'yaf', rhymesWith: 'staff', wrongs: ['yef', 'yif', 'yof'] },
            { word: 'yef', rhymesWith: 'chef', wrongs: ['yaf', 'yif', 'yof'] },
            { word: 'yek', rhymesWith: 'peck', wrongs: ['yak', 'yik', 'yok'] },
            { word: 'yel', rhymesWith: 'bell', wrongs: ['yal', 'yil', 'yul'] },
            { word: 'yim', rhymesWith: 'him', wrongs: ['yam', 'yom', 'yum'] },
            { word: 'zaf', rhymesWith: 'staff', wrongs: ['zef', 'zif', 'zof'] },
            { word: 'zem', rhymesWith: 'stem', wrongs: ['zam', 'zim', 'zom'] },
            { word: 'zid', rhymesWith: 'kid', wrongs: ['zad', 'zod', 'zud'] },
            { word: 'zif', rhymesWith: 'riff', wrongs: ['zaf', 'zef', 'zof'] },
            { word: 'zob', rhymesWith: 'rob', wrongs: ['zab', 'zib', 'zub'] },
            { word: 'zud', rhymesWith: 'mud', wrongs: ['zad', 'zid', 'zod'] }
        ],
    ...
    _rhyming2nd(level) {
        const advancedSets = [
            ...
            ['story', 'glory', 'gory', 'priory'],
            ['morning', 'boring', 'soaring', 'pouring'],
    ...
    _grammar(level) {
        ...
        if (roll < 0.2) {
            const tenseItems = [
                ...
                { sentence: 'I eat my lunch.', correct: 'Present', verb: 'eat' },
    ...
    _antonyms(level) {
        const easyPairs = [
            ...
            { word: 'open', opposite: 'close', wrongs: ['wide', 'push', 'pull'] },
