...
const MathData = {
    ...
    _addition(level) {
        ...
        if (level < 2) {
            ...
            return {
                ...
                questionSpeak: `How many ${emoji} altogether? ${a} plus ${b}?`,
                answers: answers.map(String),
                correctIndex: answers.indexOf(correct),
                topic: 'addition',
    ...
    _wpAddSimple(name, max) {
        const objects = ['apples', 'toys', 'stickers', 'cookies', 'stars', 'books', 'grapes', 'pencils', 'goldfish', 'buttons', 'shells', 'rocks'];
